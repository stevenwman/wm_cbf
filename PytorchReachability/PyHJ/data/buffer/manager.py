...
from PyHJ.data import Batch, PrioritizedReplayBuffer, ReplayBuffer
from PyHJ.data.batch import _alloc_by_keys_diff, _create_value
...
class ReplayBufferManager(ReplayBuffer):
    ...
    def __init__(
        self, buffer_list: Union[List[ReplayBuffer]]
    ) -> None:
