...
from PyHJ.policy.modelfree.BasePolicy_Annealing_Reach_Avoid import BasePolicy_Annealing_Reach_Avoid as BasePolicy # correct


class reach_avoid_DDPGPolicy_annealing(BasePolicy):
